...
\faculty{\href{http://www.famaf.unc.edu.ar}{Facultad de Matemática, Astronomía y Física}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
\begin{titlepage}
\begin{center}
{\scshape\LARGE \univname \\ \facname \par}\vspace{1cm} % University name
